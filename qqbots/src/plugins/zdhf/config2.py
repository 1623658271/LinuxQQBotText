...
class Config:
    ...
    def add(self, a):
        file = open("/var/qqbot/qqbots/src/plugins/blackMember.txt", "a+", encoding="utf-8")
        file.writelines(str(a) + '\n')
        file.close()

    def delete(self, a):
        file = open("/var/qqbot/qqbots/src/plugins/blackMember.txt", "r+", encoding="utf-8")
        ...
        for i in content:
            if str(a) == str(i):
                ...
                break
        file.close()
        file = open("/var/qqbot/qqbots/src/plugins/blackMember.txt", "w+", encoding="utf-8")
